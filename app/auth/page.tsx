...
import authImage from "@/public/auth-image.jpeg"
  ...
  return (
    <main className='h-screen grid grid-cols-2 relative'>
      <div className='relative w-full flex flex-col bg-muted p-10 text-primary-foreground'>
        ...
        <Image src={authImage} alt="login Image" fill className='w-full h-full object-cover' />
        ...
        <div className='relative z-20 mt-auto'>
          <blockquote className='space-y-2'>
            <p className='text-lg'>
              Picture AI is a game changer for me. I have been able to generate high quality profes
              sional headshots within minutes. It has saved me countless hours of work and cost as well.”
            </p>

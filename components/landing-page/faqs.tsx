...
const faqsList = [
  {
    question: "How does Picture AI work?",
    answer:
      "Picture AI uses advanced machine learning algorithms to analyze and understand your photos. It then generates new images based on your features and the scenarios you choose, creating realistic and personalized results.",
  },
  {
    question: "Is my data safe with Picture AI?",
    answer:
  ...
  {
    question: "Can I use Picture AI for commercial purposes?",
    answer:
